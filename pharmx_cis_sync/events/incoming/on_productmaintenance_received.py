...
class OnProductMaintenanceReceivedEventListener(Component):
    _name = 'datasync.productmaintenance.received.listener'
    _inherit = 'base.event.listener'

    def on_Outbound_ProductMaintenance_received(self, record: DataSyncMessage, fields=None):
        _logger.info("%r has been triggered", record)

        create_product(self, record.ProductMaintenance)
