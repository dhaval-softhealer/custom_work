...
debit note barcode mobile scanner""",
    ...
    "data": [
        ...
        # "views/stock_inventory/stock_adjustment.xml",
    ...
    "assets": {
        "web.assets_backend": [
            'sh_barcode_scanner_adv/static/src/scss/style.scss',
            'sh_barcode_scanner_adv/static/src/js/dialog_sound.js',
            'sh_barcode_scanner_adv/static/src/js/dialog.js',
            "sh_barcode_scanner_adv/static/src/js/stock_adjustment2.js",
        ...
        "web.assets_qweb": [
            ...
            # 'sh_barcode_scanner_adv/static/src/xml/stock_adjustment.xml',
        ]
    },
