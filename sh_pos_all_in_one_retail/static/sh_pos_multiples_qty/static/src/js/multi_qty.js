odoo.define('sh_pos_multiples_qty.multi_qty', function (require) {
    ...
    models.Orderline = models.Orderline.extend({
        set_quantity: function (quantity, keep_price) {
            var self = this;
            if (!self.pos.is_refund_button_click && self.pos.get_order() && !self.pos.get_order().is_refund_order) {
            ...
            if (quantity === 'remove') {
                ...
                if (unit) {
                    if (unit.rounding) {
                        ...
                        if (round_pr(quant, rounding) && this.pos.config.sh_show_qty_location && this.product.type == "product" && !this.product["is_added"] && !this.pos.config.sh_display_stock_from_other_companies) {
