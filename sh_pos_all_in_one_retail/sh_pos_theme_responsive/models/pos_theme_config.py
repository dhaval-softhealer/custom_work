...
class ResCompany(models.Model):
    ...
    is_orderline_animated = fields.Boolean("Disable Product Animations")
    
class ResConfigSettings(models.TransientModel):
    _inherit = 'res.config.settings'

    is_orderline_animated = fields.Boolean(
        string="Disable Product Animations", related='company_id.is_orderline_animated', readonly=False)
