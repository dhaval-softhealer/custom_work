odoo.define("sh_pos_switch_view.action_button", function (require) {
    ...
    const PosProductsWidgetControlPanel = (ProductsWidgetControlPanel) =>
        class extends ProductsWidgetControlPanel {
            ...
            mounted() {
                super.mounted();
                if (this.env.pos.config.pos_switch_view == false) {
            ...
            clearSearch() {
                super.clearSearch()
                if ($('.sh_product_list_main').hasClass("sh_list_with_sugggestion")) {
                    $('.sh_product_list_main').removeClass("sh_list_with_sugggestion")
                }
            }
